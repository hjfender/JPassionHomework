public class MyUsingTypeSafeEnum {

	// Note that Football Score is now enum type
	...
	public static void main(String[] args) {
		...
		System.out.println("My fooball team scored " + mytotal);
	...
	public static int calcTotal(FootballScore[] f){
		...
		for(int i = 0; i < f.length; ++i){
			total += f[i].score() + f[i].extrapoint();
		}
		return total;
	}
}
