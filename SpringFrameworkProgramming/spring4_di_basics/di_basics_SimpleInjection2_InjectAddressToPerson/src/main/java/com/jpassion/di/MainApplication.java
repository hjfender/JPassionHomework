...
public class MainApplication {
	...
	// -Define a new bean called FamilyInfo, which has the following fields
    //   String fatherName;
    //   String motherName;
    //   int numberOfSiblings
    // -Person bean should have a field of FamilyInfo
    // -Use some dummy values for creating FamilyInfo object
    // -Display the fields of the FamilyInfo bean for the person.
